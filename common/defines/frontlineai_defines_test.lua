...
NDefines.NAI.ARMY_LEADER_ASSIGN_FIELD_MARSHAL_TO_ARMY = -10000            			-- Score for assigning a field marshal to a normal army (want to use them for army groups)
NDefines.NAI.ARMY_LEADER_ASSIGN_OVERCAPACITY = -1000                     			-- Score for assigning leader to a too large army
...
NDefines.NAI.AIFC_ACTIVATE_AVG_ORG_RATIO_THRESHOLD = 0.5
NDefines.NAI.AIFC_ACTIVATE_IN_POSITION_RATIO_THRESHOLD = 0.75
