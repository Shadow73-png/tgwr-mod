...
NDefines.NAI.AIFC_ACTIVATE_AVG_ORG_RATIO_THRESHOLD = 0.6
NDefines.NAI.AIFC_ACTIVATE_IN_POSITION_RATIO_THRESHOLD = 0.7
...
NDefines.NAI.AIFC_REFRESH_NEED_SUPPLY_FACTOR_PER_DAY = 1.0

NDefines.NAI.AIFC_PATH_COST_TRN_MOUNTAINS = 5.0
NDefines.NAI.AIFC_PATH_COST_TRN_MARSH = 3.0
NDefines.NAI.AIFC_PATH_COST_TRN_PLAINS = 0.5
...
NDefines.NAI.AIFC_PATH_COST_HAS_SUPPLY_HUB = 0.2

NDefines.NAI.AIFC_FRESHNESS_ADD_ON_PROGRESS = 30.0
